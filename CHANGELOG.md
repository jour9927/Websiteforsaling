...
- 價格與出價改用新台幣；得標後以人工匯款完成付款，確認收款時原子轉移收藏與附加證章。
...
- 主頁新增民間交易雙排行榜，依已完成交易統計賣出與購入件數；同件數時以新台幣成交金額排序。
- 排行榜加入獨立的虛擬會員展示資料；不建立假拍賣、不扣點數，也不影響真實收藏與交易帳本。
- 修正水軍留言管理頁查詢不存在的虛擬頭像欄位而載入失敗。
- 民間交易全面改為新台幣人工匯款：出價不扣站內點數，得標後上傳付款證明，賣家或管理員確認收款才交付收藏。
- 新增私密收款說明、私有付款證明 Storage、付款退回補件流程；只有交易雙方與管理員可讀取。
