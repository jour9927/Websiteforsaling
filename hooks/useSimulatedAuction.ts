...
const FAKE_BIDDERS = [
    // 傳統百家姓遮蔽
    '王**', '李**', '張**', '陳**', '林**', '黃**', '趙**', '周**', '吳**', '徐**', '孫**', '馬**', '朱**', '胡**', '郭**', '何**', '高**', '林**', '鄭**', '梁**',
    // 英文簡稱遮蔽
    'L***', 'K***', 'M***', 'S***', 'T***', 'A***', 'J***', 'R***', 'D***', 'C***', 'E***', 'B***', 'P***', 'W***', 'H***', 'F***', 'V***', 'Y***', 'N***', 'G***',
    // 會員編號系列
    '會員#0892', '會員#1234', '會員#5678', '會員#3456', '會員#7890', '會員#9921', '會員#4512', '會員#0034', '會員#8832', '會員#1123', '會員#5531', '會員#7721', '會員#3091', '會員#6611',
    // 寶可夢圈內梗與稱號
    'Trainer_X', 'PKM_Fan', '神奧勇者', '卡洛斯冠軍', '關都大師', '豐緣開拓者', '帕底亞學生', '阿羅拉島主', '合眾英雄', '伽勒爾新星',
    '洗翠調查員', '圖鑑收集狂', '色違獵人', '孵蛋廢人', '對戰塔常客', 'VGC選手', '大木博士信徒', '捕蟲少年', '短褲小子', '露營好手',
    '寶可夢大師', '赤紅的鐵粉', '竹蘭老公', '大吾的石頭', '米可利杯冠軍', '華麗大賽常勝軍', '火箭隊基層', '寶可夢保育家', '地下大洞窟礦工', '太晶團戰大老',
    // 常見英文網名/ID
    'Ash_Ketchum', 'Red', 'Blue', 'Gold', 'Silver', 'Ruby', 'Sapphire', 'Diamond', 'Pearl', 'Black', 'White', 'X', 'Y', 'Sun', 'Moon', 'Sword', 'Shield', 'Scarlet', 'Violet',
    'PokeMaster99', 'ShinyHunter', 'GottaCatchEmAll', 'PikachuFan', 'CharizardMain', 'MewtwoStrikes', 'EeveeLover', 'SnorlaxSleeps', 'GengarGhost', 'LucarioAura',
    // 隨機日文風名字 (羅馬拼音或漢字)
    'Satoshi', 'TakeC', 'Yumi', 'Kenta', 'Ryu', 'Ken', 'Sakura', 'Yuki', 'Hiro', 'Taka',
    '小智', '小茂', '小光', '小遙', '莎莉娜', '希特隆', '莉莉艾', '水蓮', '瑪奧', '卡奇', '馬瑪內', '格拉吉歐', '豪', '小春'
];
