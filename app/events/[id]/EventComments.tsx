...
const SYLVEON_REPLIES: Record<number, { name: string; text: string; time: string }[]> = {
    0: [
        { name: "謝**", text: "管理團隊就是這樣啊，發卷又不敢真的給名額", time: "2026/5/2" },
        { name: "趙**", text: "習慣了啦，每次都是這樣操作的", time: "2026/5/2" },
    ],
    1: [
        { name: "徐**", text: "排除2隻算客氣了，至少不是只能排除1隻", time: "2026/5/2" },
    ],
    2: [
        { name: "馬**", text: "15人真的太少了吧，至少給個50", time: "2026/5/2" },
        { name: "朱**", text: "50？想太多，有20就偷笑了", time: "2026/5/2" },
    ],
    3: [
        { name: "胡**", text: "真的，500多人只有15人能上，根本做樣子", time: "2026/5/2" },
        { name: "高**", text: "就是發個活動交差了事的概念", time: "2026/5/2" },
    ],
    7: [
        { name: "羅**", text: "大學錄取率都沒這麼低", time: "2026/5/2" },
        { name: "劉**", text: "笑死 這比考醫科還難", time: "2026/5/2" },
        { name: "鄭**", text: "醫科還有名額，這個連名額都沒有好嗎", time: "2026/5/2" },
    ],
};
