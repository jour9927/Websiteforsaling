...
const SYLVEON_COMMENTS = [
    "所以現在是怎樣，第二梯次直接延到6/16，管理員放話都不用負責的嗎",
    "本來就15個名額還要分兩波，現在第二波還延期，我看根本沒準備好吧",
    "第二梯次延期到6/16，第一梯次沒中的繼續等到六月，有夠會拖",
    "600多人報名，結果第二梯次延期到6/16，管理團隊是不是在睡",
    "葉伊布第二梯次延到6/16，連個準確時間都沒有，先畫個6/16再說",
    "預報名排隊等到6/16，我阿嬤都知道只是換個日期繼續拖",
    "管理員：第二梯次開放中 → 隔天：延期到6/16，這組織力我給滿分",
    "第二梯次從開放變成延期到6/16，還好我完全沒期待過",
